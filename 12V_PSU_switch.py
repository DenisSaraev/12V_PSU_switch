#!/usr/bin/python3.7
'''
This script controls the 12V Power Supply Unit using a relay (normally open, hight level trigger)
'''
...
#Logger to file
fh=logging.FileHandler('/home/pi/projects/results/logs/12V_PSU_switch.log')
...
parser.add_argument(dest='statement', type=int, choices=[0,1], help='0 for disable, 1 for enable 12V PSU switch.')
...
if statement==0:
    ...
    logger.info('RELE DISABLED. PSU disactivated')
if statement==1:
    wp.digitalWrite(PIN_WP_REL, True)
    logger.info('RELE ENABLED. PSU activated')